...
1.) First things first what we have to do is create a virtual machine by going to https://portal.azure.com/. Setup your virtual machine with Windows 10 Pro, version 22H2. Note, you will want to create a virtual machine with a minimum of atleast 2 vcpus and 16 gbs of memory or more in order for the virtual machine to not run slow.

2.) Once you have created your virtual machine you will want to connect it by using the public ip address so the vm is setup with it. You will connect using the remote desktop connection app. 
</p>
<br />
...
**NOTE** Make sure all Common HTTP Features are checked.
 ...
 To make sure the IIS is installed / enabled you have to go to a browser of your choice and search for 127.0.0.1 
